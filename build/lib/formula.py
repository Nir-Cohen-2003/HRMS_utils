...
element_data = {
    'H': (1.007825, r'H(\d+|[A-Z]|$){1}'),
    'B':(11.009305, r'B(\d+|[A-Z]|$){1}'), 
    'C': (12.0000, r'C(\d+|[A-Z]|$){1}'), 
    'N': (14.003074, r'N(\d+|[A-Z]|$){1}'), 
    'O': (15.994915, r'O(\d+|[A-Z]|$){1}'), 
    'F': (18.998403, r'F(\d+|[A-Z]|$){1}'), 
    'Na': (22.989770, r'Na(\d+|[A-Z]|$){1}'),
    'Si':(27.9769265, r'Si(\d+|[A-Z]|$){1}'), 
    'P': (30.973762, r'P(\d+|[A-Z]|$){1}'), 
    'S': (31.972071, r'S(\d+|[A-Z]|$){1}'),
    'Cl': (34.96885271, r'Cl(\d+|[A-Z]|$){1}'), 
    'K': (38.963707, r'K(\d+|[A-Z]|$){1}'),
    'As':(74.921596,r'As(\d+|[A-Z]|$){1}') ,
    'Br': (78.918338, r'Br(\d+|[A-Z]|$){1}'), 
    'I': (126.904468, r'I(\d+|[A-Z]|$){1}')
    }
